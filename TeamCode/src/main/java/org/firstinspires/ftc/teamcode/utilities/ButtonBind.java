...
import org.firstinspires.ftc.teamcode.commands.group.PrepareSpecimen;
...
public class ButtonBind{
    ...
    public ButtonBind(GamepadEx g1, HardwareMap hardwareMap,Intake intake, Outtake outtake, Elevator elevator){
        ...
        buttonMap.pickSample.whenPressed(new PickUpSample(intake));
        ...
        buttonMap.prepareSpecimen.whenPressed(new PrepareSpecimen(elevator, outtake));
        buttonMap.toggleClaw.toggleWhenPressed(
