...
public class FConstants {
    static {
        ...
        FollowerConstants.leftFrontMotorName = DrivetrainConstants.leftFrontMotorName;
        FollowerConstants.leftRearMotorName = DrivetrainConstants.leftRearMotorName;
        FollowerConstants.rightFrontMotorName = DrivetrainConstants.rightFrontMotorName;
        FollowerConstants.rightRearMotorName = DrivetrainConstants.leftRearMotorName;
